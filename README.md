...
> Plataforma de motoristas particulares: passageiros encontram, favoritam e avaliam motoristas.
...
3. Cole o endereço do repositório:
   ...
   ```
   https://github.com/Artleyfin/girochoffer.git
   ```
...
> Alternativa pelo terminal: `git clone https://github.com/Artleyfin/girochoffer.git` e depois **Arquivo → Abrir Pasta** no VSCode.
...
O backend sobe em **http://localhost:8412**. A documentação da API (Swagger) fica em **http://localhost:8412/docs**.
...
O frontend abre em **http://localhost:5182**. **É por esse endereço que você acessa o sistema no navegador.** (Ele conversa sozinho com o backend.)
...
- **Aluno 1 → Favoritar motoristas e avaliar motoristas após o serviço**
  Tutorial: [`docs/TutorialAluno1.md`](docs/TutorialAluno1.md)
- **Aluno 2 → CRUD de tipos de veículo/carroceria**
