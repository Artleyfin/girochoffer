...
// para o backend FastAPI (default localhost:8412), mantendo same-origin
...
const BACKEND = process.env.VITE_BACKEND_URL || 'http://127.0.0.1:8412'
...
export default defineConfig({
  ...
  server: {
    port: 5182,
    proxy: {
      // changeOrigin:false preserva o Host do navegador (localhost:5182). Assim,
