/* Paleta e tokens visuais do GiroChoffer, portados do protótipo original
   (design/girochoffer-react/src/utils/theme.js). Usados em estilos inline. */
...
/* Mapa de cores por status, usado nos badges: [texto, fundo].
   "Com interessados" é rótulo derivado (não é status armazenado). */
...
/* Estilo de seta customizada para <select>: remove a seta nativa e
   desenha um chevron com espaçamento confortável. */
