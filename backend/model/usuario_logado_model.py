...
class UsuarioLogado:
    ...
    def is_empresa(self) -> bool:
        ...
        return self.perfil == Perfil.EMPRESA.value

    def is_motorista(self) -> bool:
        """Verifica se o usuário é motorista."""
        return self.perfil == Perfil.MOTORISTA.value
    ...
    def tem_perfil(self, *perfis: str) -> bool:
        ...
        Exemplo:
            if usuario.tem_perfil(Perfil.ADMIN.value, Perfil.EMPRESA.value):
                # lógica para admin ou empresa
        """
